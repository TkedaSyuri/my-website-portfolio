      ...
      <div className="flex justify-end pt-3">
        <div className="flex text-white w-fit cursor-default">
          <Link href="/" className="flex flex-col justify-center items-center gap-1 w-25 group">
            <div className="group-hover:text-orange-500 group-hover:scale-150 transition-transform duration-500">
              <BsFire size={20} />
            </div>
          ...
          <Link href="/profile"  className="flex flex-col justify-center items-center gap-1 w-25   group">
            <div className="group-hover:text-blue-500 group-hover:scale-150 transition-transform duration-500">
              <CgProfile size={20} />
            </div>
            <p className="text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              プロフィール
          ...
          <Link href="/portfolio"  className="flex flex-col justify-center items-center gap-1 w-25  group">
            <div className="group-hover:text-green-500 group-hover:scale-150 transition-transform duration-500">
          ...
          <Link href="/archive" className="flex flex-col justify-center items-center gap-1 w-25  group">
            <div className="group-hover:text-cyan-500 group-hover:scale-150 transition-transform duration-500">
