            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <ul className="pl-6 text-base md:text-2xl space-y-1 ">
                  ...
                  <li>
                    <span>ライブラリ：</span>Redux / Socket.io / Zod / React Hook Form
                  </li>
                </ul>
              </div>
...
<section className="relative h-screen bg-cover bg-center flex flex-col justify-center items-center">
  ...
  {/* スライドボタン */}
  <div className="absolute right-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="right" textColor={"red"} targetRef={descriptionBoxRef3} />
  </div>
  <div className="absolute left-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="left" textColor={"red"} targetRef={descriptionBoxRef3} />
  </div>
  ...
  <DescriptionBox ref={descriptionBoxRef3}>
    ...
    <div className="p-8 text-black flex flex-col min-w-[80vw] bg-red-500 rounded-xl snap-center">
      ...
      <div className="mt-15">
        ...
        <ul className="pl-6 text-base md:text-2xl list-disc">
          <li>ECS (Fargate):フロントエンド/バックエンドをそれぞれ Fargate サービスで構築。</li>
          <li>ALB + Route 53 + ACM: HTTPS 対応のロードバランサを用いて独自ドメインで運用。</li>
          <li>RDS (PostgreSQL):SSM Parameter Store で安全に認証情報を管理。</li>
    ...
    <div className="min-w-[80vw] bg-red-600 p-8 rounded-xl text-black snap-center">
      <h2 className="mb-6 text-xl md:text-3xl font-semibold border-b-2">ブログで使用した技術</h2>
      <div className="text-2xl">
        <div className="mb-8">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 underline underline-offset-4">フロントエンド</h3>
          <ul className="pl-6 text-base md:text-2xl space-y-1">
            <li><span>言語：</span>TypeScript</li>
            <li><span>フレームワーク：</span>Next.js</li>
          </ul>
        </div>

        <div className="mb-8">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 underline underline-offset-2">バックエンド</h3>
          <ul className="pl-6 text-base md:text-2xl space-y-1">
            <li><span>言語：</span>Ruby</li>
            <li><span>フレームワーク：</span>Ruby on Rails</li>
          </ul>
        </div>
    ...
    <div className="min-w-[80vw] bg-red-700 p-8 rounded-xl text-black snap-center">
      ...
      <div className="text-base md:text-2xl flex flex-col gap-4">
        <h3 className="text-xl md:text-2xl font-semibold underline underline-offset-4">ブログのリソース</h3>
        <p className="font-semibold break-words">
          <span>フロントエンド: </span>
          <Link
...
<section className="relative h-screen bg-cover bg-center flex flex-col justify-center items-center">
  <h2 className="font-bold text-white text-xl sm:text-4xl mb-4">
    CDK × AWSリソース で「AWS ECS on Fargate でブログを構築」を一括構築・削除
  </h2>

  {/* スライドボタン */}
  <div className="absolute right-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="right" textColor={"pink"} targetRef={descriptionBoxRef4} />
  </div>
  <div className="absolute left-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="left" textColor={"pink"} targetRef={descriptionBoxRef4} />
  </div>
...
<section className="relative h-screen bg-cover bg-center  flex flex-col justify-center items-center">
  ...
  {/* スライドボタン */}
  <div className="absolute right-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="right" textColor={"orange"} targetRef={descriptionBoxRef5} />
  </div>
  <div className="absolute left-4 top-1/2 -translate-y-1/2 z-50">
    <SlideButton direction="left" textColor={"orange"} targetRef={descriptionBoxRef5} />
  </div>
  ...
  <DescriptionBox ref={descriptionBoxRef5}>
    ...
    <div className="p-8 text-black min-w-[80vw] bg-orange-400 rounded-xl snap-center">
      <div>
        <h2 className="text-xl md:text-3xl font-semibold mb-4 border-b-2">概要</h2>
    ...
    <div className="min-w-[80vw] bg-orange-500 p-8 rounded-xl text-black snap-center">
      <h2 className="mb-6 text-xl md:text-3xl font-semibold border-b-2">使用技術</h2>
      ...
      <div className="mb-8">
        ...
        <ul className="pl-6 text-base md:text-2xl space-y-1">
          <li><span>言語：</span>TypeScript</li>
          <li><span>フレームワーク：</span>Next.js</li>
          <li><span>ライブラリ：</span>React Three Fiber / GSAP</li>
        </ul>
      </div>

      <div>
        <h3 className="text-xl md:text-2xl font-semibold mb-2 underline underline-offset-4">インフラ・その他</h3>
        <ul className="pl-6 text-xl md:text-2xl space-y-1">
          <li>Vercel</li>
        </ul>
      </div>
