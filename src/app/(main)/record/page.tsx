...
const RecordPage = () => {
  return (
    <div className=" relative z-20 h-screen  py-10">
      <h1 className="text-white">ヘッダー</h1>

      <div className=" overflow-y-auto max-h-[75vh] scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-300">
        {/* このページの説明 */}
        <p className="text-white mb-4 text-center ">
          このページでは、これまでに学習してきたプログラミング言語、フレームワーク、ライブラリなどの技術を一覧形式で紹介しています。途中まで取り組んだものも含めて掲載しています。
        </p>
        <div className="flex justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 ">
            {Data.map((items) => (
              <div
                key={items.id}
                className="flex flex-col items-center  mt-2 p-2 m-2  w-96 text-white  border-blue-500 border rounded  "
              >
